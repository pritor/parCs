...
int main()
{
    ...
    std::vector<LinearArguments> parameters =
            {
                    LinearArguments("../task6/Weights/weights1", "../task6/Weights/bias1", 32 * 32, 16 * 16),
                    LinearArguments("../task6/Weights/weights2", "../task6/Weights/bias2", 16 * 16, 4 * 4),
                    LinearArguments("../task6/Weights/weights3", "../task6/Weights/bias3", 4 * 4, 1)
            };
